...
namespace sistema_gestao_estudantes
{
    internal class Estudante
    {
        ...
        // Função que inclui o estudante no banco de dadoscsjhzcshscvh.
        ...
        public bool deletarEstudante(int id)
        {
            MySqlCommand comando =
                new MySqlCommand("DELETE FROM `estudante` WHERE 0`id` = @studentid");
        ...
        public DataTable pegarEstudante(MySqlCommand comando)
        {
